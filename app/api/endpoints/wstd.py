...
from app.schemas import WaterResourcesRequest, WaterResourcesResponse
...
async def get_small_water_resources(
    ...
    startDatetime: Optional[datetime] = Query(None, description="Start date (required if latest is false)"),
    endDatetime: Optional[datetime] = Query(None, description="End date (required if latest is false)"),
    provinceCode: Optional[str] = Query(None, description="Province code filter"),
    amphoeCode: Optional[str] = Query(None, description="Amphoe code filter"),
    tambonCode: Optional[str] = Query(None, description="Tambon code filter"),
):
